...
function init() {
  ...
  //   屋根の作成
  mesh = new THREE.Mesh(new myTriangleGeometry( v[2], v[3], v[6]), bodyMaterial);
  car.add(mesh);
  ...
  car.add(mesh);
  //     右窓
  mesh = new THREE.Mesh(new myTriangleGeometry( v[5], v[7], v[4]), glassMaterial);
  car.add(mesh);
  mesh = new THREE.Mesh(new myTriangleGeometry( v[6], v[4], v[7]), glassMaterial);
  car.add(mesh);
  //     前窓
  ...
  car.add(mesh);
  //     後窓
  mesh = new THREE.Mesh(new myTriangleGeometry( v[1], v[3], v[5]), glassMaterial);
  car.add(mesh);
  mesh = new THREE.Mesh(new myTriangleGeometry( v[7], v[5], v[3]), glassMaterial);
  car.add(mesh);
